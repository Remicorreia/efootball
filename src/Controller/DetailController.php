...
class DetailController extends AbstractController
{
    ...
    public function new(Request $request, DetailRepository $detailRepository): Response
    {
        $detail = new Detail();
    ...
    public function edit(Request $request, Detail $detail, DetailRepository $detailRepository): Response
    {
        $form = $this->createForm(DetailType::class, $detail);
        $form->handleRequest($request);
    ...
    public function delete(Request $request, Detail $detail, DetailRepository $detailRepository): Response
    {
