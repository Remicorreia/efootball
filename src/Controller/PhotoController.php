...
class PhotoController extends AbstractController
{
    ...
    public function new(Request $request, PhotoRepository $photoRepository, GestionImage $gestionImage): Response
    {
        $photo = new Photo();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $gestionImage->manageImage($photo, $form);
    ...
    public function edit(Request $request, Photo $photo, PhotoRepository $photoRepository, GestionImage $gestionImage): Response
    {
        $form = $this->createForm(PhotoType::class, $photo);
        $form->handleRequest($request);
